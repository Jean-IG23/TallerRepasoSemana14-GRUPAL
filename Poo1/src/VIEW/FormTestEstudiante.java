...
public class FormTestEstudiante extends javax.swing.JFrame {
    ...
    public FormTestEstudiante() {
        ...
        initComponents();
        modelo = (DefaultTableModel) this.jTable1.getModel();
        procesarEstudiantes = new ProcesarEstudiantes();
    }
    ...
    private ProcesarEstudiantes procesarEstudiantes;

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String nombreEstudiante = "Jean";
        double nota1 = 8.9;
        double nota2 = 9.8;

        Estudiante nuevoEstudiante = new Estudiante(nombreEstudiante, nota1, nota2);
        procesarEstudiantes.insertarEstudiante(nuevoEstudiante);

        modelo.addRow(new Object[]{nuevoEstudiante.nombreEst, nuevoEstudiante.nota1, nuevoEstudiante.nota2, nuevoEstudiante.promedio, nuevoEstudiante.estado});
    }
